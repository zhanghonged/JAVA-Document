...
**1.3节中生产者、消费者采用线程池来实现，重点是修改测试类，采用线程池方式开启线程执行，但吃货线程类和包子铺线程类要修改为implements Runnable方式：**
...
![03-Overview](images/03-Overview.png)
...
![01-交通方式](images/01-交通方式.png)

当我们需要从北京到上海时，可以选择高铁、汽车、骑行或是徒步。我们的真正目的是到达上海，而如何才能到达上海的形式并不重要，所以我们一直在探索有没有比高铁更好的方式——搭乘飞机。

![02-Lambda](images/02-Lambda.png)
